...
function SellBooks() {
    ...
    function formValid(e){
            ...
            if(user.phoneNumber.toString().length == 10){
                if(user.bookTitle.length < 100){
                    let book  = addBook(user);
    ...
    //TODO: Take all the form, and setUser code into its own component and just render out this without all setter Logic
    return (
        <div className="container">
            ...
            <div class="mb-3">
                ...
                <input type="number"
                    class="form-control form-control-lg" name="phNumber" id="phNumber" aria-describedby="helpId" placeholder="" onChange={(e)=>{setUser({...user, phoneNumber: parseInt(e.target.value)})
...
{                        // TODO: Add googles cit API here
                ...
                <div className="col-4">
                    <div class="mb-3">
                        ...
                        <input type="number"
                            class="form-control form-control-lg" name="price" id="price" aria-describedby="helpId" placeholder="" onChange={(e)=>{setUser({...user, price: parseInt(e.target.value)})}} required/>
                    </div>
                </div>
            ...
            <div class="mb-3">
                ...
                <select class="form-select form-select-lg" name="" defaultValue={user.condition} onChange={(e)=>{setUser({...user, condition: e.target.value})
